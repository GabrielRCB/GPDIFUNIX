@extends('layout.main')
@section('judul','Tambah Data Pendeta')
...
@section('content')
    ...
    {{--        </div>--}}
    {{--    @endif--}}
    <form method="post" action="{{url('profilependeta/insert')}}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            @enderror
                            <p></p>
                            <img id="tampilFotoPendeta" onerror="this.onerror=null; this.src='https://t4.ftcdn.net/jpg/04/73/25/49/360_F_473254957_bxG9yf4ly7OBO5I0O5KABLN930GwaMQz.jpg'; " src="" alt="" width="15%">
                        </div>
