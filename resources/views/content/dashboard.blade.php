        ...
        <div class="col-lg-4 col-md-6 mb-md-0 mb-4">
            <div class="card shadow-xs border h-100">
                <div class="card-header pb-0">
                    <h6 class="font-weight-semibold text-lg mb-3">Total Pengguna Saat Ini</h6>
                    <h2 class="mb-0 fs-5">Total Users: {{ $totalUser }}</h2>
                </div>
                <div class="card-body">
                    <h2>Data Admin saat ini</h2> <br>
                    <div class="row">
                        @foreach($adminUsers as $adminUser)
                        <div class="col-4 mb-1"> <!-- Tambahkan mb-3 untuk memberikan margin bawah -->
                            <p>{{ $adminUser->name }}</p>
                        </div>
                        @endforeach
                    </div>
            ...
            <div class="card shadow-xs border">
                <div class="card-header border-bottom pb-0">
                    <div class="d-sm-flex align-items-center mb-3">
                        <div>
                            <h6 class="font-weight-semibold text-lg mb-0">Profile Pendeta</h6>
                        </div>
                ...
                <div class="d-sm-flex align-items-center p-3">
                    <img src="{{route('storage',$profilePendeta->foto_pendeta)}}" width="100px" height="100px" class="me-3">
                    <div class="ms-3"> <!-- Menambahkan margin kiri -->
                        <h5 class="font-weight-bold mb-2">{{$profilePendeta->nama_pendeta}}</h5>
                        <p class="mb-0">{{$profilePendeta->moto}}</p>
                    </div>
                </div>
                @else
                <!-- Handle case when $profilePendeta is null -->
                @endif
            </div>            
        </div>
    </div>
