@extends('layout.main')
@section('judul','Tambah Data Media Pojok Jemaat')
...
@section('content')
    ...
    {{--        </div>--}}
    {{--    @endif--}}
    <form method="post" action="{{url('pojokjemaat/insert')}}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            @enderror
                            <p></p>
                            <video id="tampilVideo" onerror="this.onerror=null; this.src='https://via.placeholder.com/150';" width="15%" controls>
