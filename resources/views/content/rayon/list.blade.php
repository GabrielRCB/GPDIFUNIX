...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <a class="btn btn-primary mb-2" href="{{url('/rayon/add')}}">Tambah Data Ibadah Rayon</a>
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                            @php
                                $i = (($rayon->currentPage() -1)* $rayon->perPage())+1;
                            @endphp
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning btn-sm"
                                           href="{{url('rayon/edit/'.$row->id)}}">
                                            <i class="fas fa-edit  "></i>
                                        </a>
                                        <button type="button"
                                                data-id-rayon="{{$row->id}}"
    ...
    <script>
        $(function () {
            $('.btn-hapus').on('click', function () {
                let idRayon = $(this).data('id-rayon');
